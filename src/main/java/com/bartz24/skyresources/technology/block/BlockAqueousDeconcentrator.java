...
public class BlockAqueousDeconcentrator extends BlockMachine
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockAqueousDeconcentrator(String unlocalizedName, String registryName, float hardness, float resistance)
	{
			...
			EnumFacing side, float hitX, float hitY, float hitZ)
	{
		if (!world.isRemote)
		{
			...
			player.openGui(SkyResources.instance, ModGuiHandler.AqueousConcentratorGUI, world, pos.getX(), pos.getY(),
					pos.getZ());
		}
		return true;
	}
